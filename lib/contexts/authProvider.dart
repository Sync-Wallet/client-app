...
class AuthProvider extends ChangeNotifier {
  ...
  Future<void> login() async{
    ...
    final headers = {
      ...
      'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiQWJoaXNoZWsiLCJpYXQiOjE2OTE4NTk0NjMsImV4cCI6MTY5NDQ1MTQ2M30.p_qzcPbQZK0N2EJgHuI8yFklSbtEnz7F40WilCEYuwA',
    };
    final body = {
      'email': _email,
      'password': _password,
